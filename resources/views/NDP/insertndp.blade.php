    ...
    <div class="row "> <!-- Centering the row -->
        ...
        <div class="col-md-3">
            ...
            <div class="card my-1" style="width: 100%;  ">
                <div class="card-body ">
                    <h2 class="d-flex justify-content-center text-center">NOTE DE PECHE</h2>
                    <div class="form-row">
    ...
    <script>
        ...
        data.map((cate, index) => {
            ...
            if (cate.category === "DENTON" || cate.category === "AFRIQUE") {
                cate.data.map((fish) => {
                    ...
                    nameCell.className = "col-2 p-0"
                    nameCell.id = cate.category

                    var quantityCell = document.createElement('td');
                    quantityCell.className = "col-1 p-0"
        ...
        /*const handlevalider = (e) => {
            ...
            if (leftTableBody.length > 0) {
                leftTableBody.forEach(row => {
                    const fishname = row.cells[0].textContent.trim();
                    const category = row.cells[0].id;
            ...
            if (SecondleftTableBody.length > 0) {
                SecondleftTableBody.forEach(row => {
                    const fishname = row.cells[0].textContent.trim();
                    const category = row.cells[0].id;
                    const inputelement = row.cells[1].querySelector('input');
                    const quantity = inputelement ? inputelement.value.trim() : '00.00';
            ...
            if (SecondrightTableBody.length > 0) {
                SecondrightTableBody.forEach(row => {
                    const fishname = row.cells[0].textContent.trim();
                    const category = row.cells[0].id;
                    const inputelement = row.cells[1].querySelector('input');
                    const quantity = inputelement ? inputelement.value.trim() : '00.00';
