        ...
        <div class="card card p-5" style="width: 100%">
            ...
            {{-- <div class="row my-5">
                <div class="container">
                    <ul class="list-unstyled d-flex justify-content-between">
                        <li>
                            <a href="{{route('test',['maree' => $maree])}}" class="btn btn-primary border border-dark rounded" >
            ...
            <div class="container">
                <ul class="list-unstyled d-flex justify-content-between">
                    ...
                    <li>
                        <a href="{{ route('generatepdf', ['maree' => $maree]) }}">
            ...
            <table class="table   data-table1" style="min-width: 100%" id="myTable">
                ...
                <tbody>
                        ...
                        @foreach ($categoryData as $item)
                            <tr id="{{ $category }}">
                                ...
                                <td class="text-center">
                                    <p id="canchange"  class="mb-0">{{ $item->fishquantity }}</p>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <tr>
                        ...
                        <td class="text-center"><strong>{{ $totalgen }}</strong></td>
                    </tr>
                </tbody>
